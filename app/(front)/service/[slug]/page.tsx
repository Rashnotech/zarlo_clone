...
export default async function page({
  ...
  const data = (await getBeauticiansByServiceSlug(slug)) as DataProps;
      ...
      <div className="container px-6 py-8">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-gray-600">Beauty Services</span>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-baseline gap-4">
              ...
              <span className="text-lg font-medium text-gray-500">
                ({beauticians?.length.toString().padStart(2, "0")} experts)
              </span>
            </div>
              ...
              <Card className="border-0 shadow-sm bg-white/50 backdrop-blur-sm">
                <CardContent className="flex flex-col items-center justify-center p-12 text-center">
                  ...
                  <h2 className="text-xl font-medium text-gray-900 mb-2">
                    No Beauticians Available
                  </h2>
                  <p className="text-gray-500">
                    We couldn't find any beauticians for {title} at the moment.
                  </p>
                </CardContent>
              </Card>
            )}
