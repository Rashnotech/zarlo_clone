...
export default function ProfileInfoForm({
  ...
  const initialExpiryDate =
    beauticianProfile.medicalLicenseExpiry || savedDBData.medicalLicenseExpiry;
  const initialProfileImage =
    beauticianProfile.profilePicture || savedDBData.profilePicture;
  ...
  const {
    ...
    defaultValues: {
      bio: beauticianProfile.bio || savedDBData.bio,
      page: beauticianProfile.page || savedDBData.page,
      medicalLicense:
        beauticianProfile.medicalLicense || savedDBData.medicalLicense,
      medicalLicenseExpiry:
        beauticianProfile.medicalLicenseExpiry ||
        savedDBData.medicalLicenseExpiry,
      yearsOfExperience:
        beauticianProfile.yearsOfExperience || savedDBData.yearsOfExperience,
    },
  });
    ...
    <div className="w-full">
      ...
      <form className=" py-4 px-4  mx-auto " onSubmit={handleSubmit(onSubmit)}>
        <div className="grid gap-4 grid-cols-2">
          <TextInput
            label="Medical/Beauty License"
            register={register}
            name="medicalLicense"
            errors={errors}
            placeholder="Enter Medical/Beauty License"
          />
          <TextInput
          ...
          <DatePickerInput
            ...
            date={expiry}
            setDate={setExpiry}
            title="Medical/Beauty License Expiry"
          />
          <TextAreaInput
            ...
            name="bio"
            errors={errors}
            placeholder="Enter your Biography & Services Offered"
          />
          <ImageInput
            label="Professional Profile Image"
            imageUrl={profileImage}
            setImageUrl={setProfileImage}
            endpoint="beauticianProfileImage"
          />
        </div>
