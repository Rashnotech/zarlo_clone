...
import {
  ServiceWithBeauticianProfileCount,
  updateBeauticianProfileWithService,
...
export default function UpdateServiceForm({
  ...
  services: ServiceWithBeauticianProfileCount[] | null;
  specialties: Speciality[] | null;
  symptoms: Symptom[] | null;
  profile: BeauticianProfile | undefined | null;
}) {
  ...
  const operationModes = [
    ...
    },
    {
      ...
      slug: "inperson-beautician-visit",
      icon: Map,
    },
  ];
  async function handleUpdateService() {
    ...
    try {
      await updateBeauticianProfileWithService(profileId, data);
