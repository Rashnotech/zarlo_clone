      ...
      <div className="p-4">
        ...
        <div className="py-6 grid grid-cols-3 gap-3">
          <button
            ...
            className="flex items-center justify-center py-2 px-2 border border-yellow-500  rounded-md text-sm"
          >
            <span>Add All</span>
          ...
          {selectedTimes.map((time, i) => {
            return (
              <button
                ...
                key={i}
                className="flex items-center py-2 px-2 border border-yellow-500 bg-blue-50 dark:text-slate-900 rounded-md text-sm justify-center"
              >
                <span>{time}</span>
