...
export default function ContactInfo({
  ...
  const {
    ...
    defaultValues: {
      email: beauticianProfile.email || savedDBData.email,
      phone: beauticianProfile.phone || savedDBData.phone,
      country: beauticianProfile.country || savedDBData.country,
      city: beauticianProfile.city || savedDBData.city,
      state: beauticianProfile.state || savedDBData.state,
