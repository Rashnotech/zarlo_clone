...
import UpdateAppointmentForm from "@/components/Dashboard/Beautician/UpdateAppointmentForm";
  ...
  return (
    <div>
      ...
      <div className="py-4">
        ...
        <div className="flex divide-x-2 px-4 py-3 divide-gray-200 border-b">
          <p className="px-3 text-sm font-semibold">Medical/Beauty Docs</p>
        ...
        <div className="">
          ...
          {appointment && appointment.id && (
            <div className="flex items-center justify-between border-b px-8">
              ...
              <Button>
                <Link href={appointment.meetingLink}>Meet</Link>
              </Button>
            </div>
